...
printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 1, 1); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 1, 4); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 1, 14); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 1, 19); # ,{sp=>1}
print $file;



printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 2, 1); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 2, 4); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 2, 14); # ,{sp=>1}
print $file;

printf "%s\n", "-"x80;
$file = solhybrid_spp::fileread($socket, 2, 19); # ,{sp=>1}
print $file;
